        ...
        <section id="packages" className={`py-24 transition-all duration-700 ${getThemeBg()}`}>
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-8 lg:gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {/* PARTY PACK */}
                    <Card className="shiny-card group relative flex flex-col overflow-hidden border-0 bg-white transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 rounded-xl shadow-lg">
                    ...
                    <Card className="shiny-card shiny-card-gold group relative flex flex-col overflow-hidden border-0 bg-gradient-to-b from-slate-900 to-slate-800 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/20 hover:-translate-y-2 lg:scale-105 z-10 rounded-xl shadow-lg shadow-amber-500/10">
                        {/* Product Image - 4:3 Aspect Ratio */}
                    ...
                    {/* CUSTOM PACKAGE */}
                    <Card className="shiny-card flex flex-col border-0 bg-gradient-to-br from-white to-blue-50/30 transition-all hover:shadow-xl hover:-translate-y-1 rounded-xl shadow-lg">
